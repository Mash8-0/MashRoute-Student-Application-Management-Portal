...
${status ? `<table class="statusPill" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 18px;"><tr><td style="padding:1px;border-radius:999px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 14px rgba(35,136,255,.32);"><table role="presentation" cellpadding="0" cellspacing="0" style="background:#0B2040;border-radius:999px;"><tr height="30" style="height:30px;"><td width="28" height="30" align="center" valign="middle" style="width:28px;height:30px;padding:0 0 0 10px;text-align:center;vertical-align:middle;"><img src="https://mashroute.com/email-assets/status-wifi-green.png" width="20" height="20" alt="Current status" style="display:block;width:20px;height:20px;border:0;outline:none;"></td><td height="30" valign="middle" style="height:30px;padding:0 4px 0 7px;vertical-align:middle;white-space:nowrap;"><span style="display:inline-block;padding:2px 6px;background:#123524;border:1px solid #22C55E;border-radius:999px;color:#4ADE80;font-family:Arial,Helvetica,sans-serif;font-size:9px;font-weight:900;line-height:12px;letter-spacing:.8px;text-shadow:0 0 6px #22C55E;"><strong style="color:#4ADE80;font-weight:900;">LIVE</strong></span></td><td height="30" valign="middle" style="height:30px;padding:0 14px 0 6px;color:#EAF2FF;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:800;line-height:16px;letter-spacing:.35px;vertical-align:middle;white-space:nowrap;"><strong style="display:block;color:#EAF2FF;font-weight:800;line-height:16px;">${escapeHtml(labelStatus(status))}</strong></td></tr></table></td></tr></table>` : ''}
