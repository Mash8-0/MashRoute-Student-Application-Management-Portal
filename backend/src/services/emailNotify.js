...
${status ? `<table class="statusPill" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 18px;"><tr><td style="padding:1px;border-radius:999px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 14px rgba(35,136,255,.32);"><table role="presentation" cellpadding="0" cellspacing="0"><tr><td style="padding:7px 13px;background:#0B2040;border-radius:999px;color:#F8FAFC;font-size:12px;font-weight:800;letter-spacing:.5px;white-space:nowrap;"><span style="display:inline-block;width:7px;height:7px;margin-right:8px;background:#10D9F5;border-radius:50%;vertical-align:1px;box-shadow:0 0 7px #10D9F5;">&nbsp;</span><strong style="color:#F8FAFC;font-weight:800;">${escapeHtml(labelStatus(status))}</strong></td></tr></table></td></tr></table>` : ''}
