...
<tr><td colspan="2" align="center" style="padding:12px 16px 9px;border-bottom:1px solid #334561;color:#10D9F5;font-size:16px;font-weight:900;line-height:1.2;text-align:center;"><span class="gradientText" style="color:#10D9F5;font-weight:900;">APPLICATION DETAILS</span></td></tr><tr><td colspan="2" style="padding:0;"><table role="presentation" width="76%" align="center" cellpadding="0" cellspacing="0" style="width:76%;margin:0 auto;">${detailRows}</table></td></tr></table>
