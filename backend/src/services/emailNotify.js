...
${status ? `<table class="statusPill" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 18px;"><tr><td style="padding:1px;border-radius:999px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 14px rgba(35,136,255,.32);"><table role="presentation" cellpadding="0" cellspacing="0" style="background:#0B2040;border-radius:999px;"><tr><td width="30" align="center" valign="middle" style="width:30px;padding:5px 0 5px 10px;text-align:center;vertical-align:middle;"><img src="https://mashroute.com/email-assets/status-wifi.png" width="22" height="22" alt="Current status" style="display:block;width:22px;height:22px;border:0;outline:none;"></td><td valign="middle" style="padding:7px 4px 7px 7px;color:#22C55E;font-family:Arial,Helvetica,sans-serif;font-size:11px;font-weight:900;line-height:16px;letter-spacing:.7px;vertical-align:middle;white-space:nowrap;text-shadow:0 0 8px #22C55E;"><strong style="color:#22C55E;font-weight:900;">LIVE</strong></td><td valign="middle" style="padding:7px 14px 7px 7px;color:#F8FAFC;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:800;line-height:16px;letter-spacing:.5px;vertical-align:middle;white-space:nowrap;"><strong style="color:#F8FAFC;font-weight:800;">${escapeHtml(labelStatus(status))}</strong></td></tr></table></td></tr></table>` : ''}
