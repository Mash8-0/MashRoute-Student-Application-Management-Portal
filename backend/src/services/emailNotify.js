...
function createApplicationNotificationTemplate({
  ...
  const detailRows = rows.map(([label, value], index) => {
    ...
    return `
    <tr>
      <td class="detailLabel${isLast ? ' lastDetail' : ''}" width="20%" style="width:20%;padding:6px 8px${isLast ? ' 14px' : ''};color:#CBD5E1;font-size:13px;font-weight:700;line-height:1.35;text-align:left;vertical-align:top;white-space:nowrap;">${escapeHtml(label)}</td>
      <td class="detailValue${isLast ? ' lastDetail' : ''}" width="80%" style="width:80%;padding:6px 8px${isLast ? ' 14px' : ''};color:#F8FAFC;font-size:13px;font-weight:700;line-height:1.35;text-align:left;vertical-align:top;word-break:normal;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;font-size:inherit;line-height:inherit;"><tr><td width="16" style="width:16px;color:#F8FAFC;font-weight:700;text-align:left;vertical-align:top;">:</td><td style="color:#F8FAFC;font-weight:700;text-align:left;vertical-align:top;word-break:normal;">${escapeHtml(value)}</td></tr></table></td>
    </tr>
  `;
  }).join('');

  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@supports (-webkit-background-clip:text){.gradientText{background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}}@media only screen and (max-width:640px){.shell{padding:4px!important}.card{border-radius:14px!important}.pad{padding-left:14px!important;padding-right:14px!important}.brand{font-size:17px!important}.heading{font-size:20px!important}.message{font-size:12px!important;line-height:1.5!important}.statusPill{font-size:11px!important}.details{width:85%!important}.detailLabel{width:20%!important;padding:4px 5px!important;font-size:10px!important}.detailValue{width:80%!important;padding:4px 5px!important;font-size:11px!important}.lastDetail{padding-bottom:10px!important}.cta{width:160px!important;max-width:68%!important}.ctaLink{padding:11px 8px!important;font-size:11px!important}.footer{font-size:10px!important}}</style></head>
...
${status ? `<table class="statusPill" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 18px;"><tr><td style="padding:1px;border-radius:999px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 14px rgba(35,136,255,.32);"><table role="presentation" cellpadding="0" cellspacing="0" style="background:#0B2040;border-radius:999px;"><tr height="30" style="height:30px;"><td width="28" height="30" align="center" valign="middle" style="width:28px;height:30px;padding:0 0 0 10px;text-align:center;vertical-align:middle;"><img src="https://mashroute.com/email-assets/status-wifi-green.png" width="20" height="20" alt="Current status" style="display:block;width:20px;height:20px;border:0;outline:none;"></td><td height="30" valign="middle" style="height:30px;padding:0 4px 0 2px;color:#4ADE80;font-family:Arial,Helvetica,sans-serif;font-size:10px;font-weight:900;line-height:16px;letter-spacing:.8px;text-shadow:0 0 6px #22C55E;vertical-align:middle;white-space:nowrap;"><strong style="color:#4ADE80;font-weight:900;">LIVE</strong></td><td height="30" valign="middle" style="height:30px;padding:0 14px 0 6px;color:#EAF2FF;font-family:Arial,Helvetica,sans-serif;font-size:12px;font-weight:800;line-height:16px;letter-spacing:.35px;vertical-align:middle;white-space:nowrap;"><strong style="display:block;color:#EAF2FF;font-weight:800;line-height:16px;">${escapeHtml(labelStatus(status))}</strong></td></tr></table></td></tr></table>` : ''}
<div style="height:12px;line-height:12px;font-size:1px;">&nbsp;</div>
<table class="details" role="presentation" width="85%" align="center" cellpadding="0" cellspacing="0" style="width:85%;margin:0 auto 20px;background:#08172E;border:1px solid #334561;border-radius:16px;">
<tr><td colspan="2" align="center" style="padding:12px 16px 9px;border-bottom:1px solid #334561;color:#10D9F5;font-size:16px;font-weight:900;line-height:1.2;text-align:center;"><span class="gradientText" style="color:#10D9F5;font-weight:900;">APPLICATION DETAILS</span></td></tr><tr><td colspan="2" style="padding:0;"><table role="presentation" width="92%" align="right" cellpadding="0" cellspacing="0" style="width:92%;margin:0 1% 0 auto;">${detailRows}</table></td></tr></table>
<table role="presentation" align="center" width="65%" cellpadding="0" cellspacing="0" style="width:65%;margin:30px auto 0;"><tr><td style="border-top:1px solid #2388FF;line-height:1px;">&nbsp;</td><td width="32" style="color:#10D9F5;font-size:16px;">&#10022;</td><td style="border-top:1px solid #8B2CF5;line-height:1px;">&nbsp;</td></tr></table>
