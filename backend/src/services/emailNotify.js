...
<tr><td colspan="2" align="center" style="padding:11px 16px 8px;border-bottom:1px solid #334561;color:#10D9F5;font-size:14px;font-weight:800;text-align:center;"><span class="gradientText" style="color:#10D9F5;font-weight:800;">APPLICATION DETAILS</span></td></tr>${detailRows}</table>
