...
function renderHtml(input) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@supports (-webkit-background-clip:text){.gradientText{background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}.panelTitle{background-image:linear-gradient(90deg,#10D9F5,#8B2CF5);-webkit-background-clip:text;background-clip:text;color:transparent!important}}@media only screen and (max-width:640px){.shell{padding:5px!important}.card{width:100%!important;max-width:100%!important;border-radius:15px!important}.pad{padding-left:16px!important;padding-right:16px!important}.topPad{padding-top:20px!important}.contentPad{padding-bottom:24px!important}.hero{font-size:21px!important;letter-spacing:-.3px!important;line-height:1.18!important}.title{font-size:26px!important;line-height:1.14!important;margin-top:9px!important}.label,.value{display:block!important;width:auto!important;text-align:left!important;padding-left:16px!important;padding-right:16px!important}.label{font-size:12px!important;padding-top:9px!important;padding-bottom:0!important}.value{font-size:14px!important;padding-top:2px!important;padding-bottom:7px!important}.art{width:160px!important;max-width:58%!important}.cta{width:100%!important}.ctaLink{font-size:15px!important;padding:14px 12px!important}.accent{width:48px!important}.salute{margin-bottom:8px!important;font-size:16px!important}.intro{font-size:14px!important;line-height:1.55!important;margin-bottom:20px!important}.supporting{font-size:13px!important;line-height:1.5!important;margin:18px 0!important}.panelHeading{padding:15px 16px 10px!important}.panelTitle{font-size:14px!important}.autoNotice{font-size:13px!important}.footerText{font-size:11px!important;line-height:1.45!important}}</style></head>
...
<table class="card" role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;background:#06132A;border:2px solid #10D9F5;border-radius:22px;overflow:hidden;box-sizing:border-box;box-shadow:0 0 34px rgba(35,136,255,.24),0 0 18px rgba(139,44,245,.12);">
<tr><td class="pad topPad" style="padding:26px 24px 4px;text-align:center;"><p class="salute" style="margin:0 0 12px;text-align:left;font-size:18px;line-height:1.45;color:#CBD5E1;">Dear <strong style="color:#F8FAFC;">${salutation}</strong>,</p><img class="art" src="${escapeHtml(props.illustrationUrl)}" width="230" alt="Offer Letter Issued" style="display:block;margin:0 auto;width:230px;max-width:72%;height:auto;border:0;filter:drop-shadow(0 0 12px rgba(35,136,255,.32));"></td></tr>
<tr><td class="pad contentPad" style="padding:4px 24px 30px;text-align:center;">
<h1 class="hero" style="margin:0;color:#F8FAFC;font-size:30px;line-height:1.12;letter-spacing:0;text-transform:uppercase;white-space:nowrap;">CONGRATULATIONS!</h1>
<h2 class="title" style="margin:12px 0 13px;color:#10D9F5;font-size:35px;line-height:1.1;"><span class="gradientText" style="color:#10D9F5;">Offer Letter Issued</span></h2>
<table role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto 25px;"><tr><td class="accent" width="105" style="width:105px;border-top:1px solid #2388FF;font-size:1px;line-height:1px;">&nbsp;</td><td style="padding:0 15px;color:#10D9F5;font-size:18px;line-height:18px;">&#10022;</td><td class="accent" width="105" style="width:105px;border-top:1px solid #8B2CF5;font-size:1px;line-height:1px;">&nbsp;</td></tr></table>
<p class="intro" style="margin:0 0 27px;text-align:left;color:#F8FAFC;font-size:17px;line-height:1.65;">We are pleased to inform you that the Offer Letter has been issued as per the details below:</p>
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;background:#08172E;border:1px solid #334561;border-radius:18px;box-shadow:inset 0 0 20px rgba(16,217,245,.03);">
<tr><td class="panelHeading" colspan="2" style="padding:20px 24px 14px;font-size:18px;font-weight:700;text-align:left;border-bottom:1px solid #334561;"><span style="display:inline-block;color:#10D9F5;border:1px solid #10D9F5;border-radius:50%;width:28px;height:28px;line-height:28px;text-align:center;">&#9675;</span>&nbsp;&nbsp;<span class="panelTitle" style="color:#10D9F5;">STUDENT DETAILS</span></td></tr>
${[['Student Name', `<strong>${escapeHtml(props.studentName)}</strong>`], ['Passport No.', `<strong>${escapeHtml(props.passportNumber)}</strong>`], ['Programme', escapeHtml(props.programmeName)], ['Campus', escapeHtml(props.campusName)]].map(([label, value]) => `<tr><td class="label" width="35%" style="padding:12px 24px;color:#CBD5E1;font-size:15px;text-align:left;vertical-align:top;">${label}&nbsp;&nbsp;:</td><td class="value" style="padding:12px 24px;color:#F8FAFC;font-size:15px;text-align:left;vertical-align:top;word-break:break-word;">${value}</td></tr>`).join('')}
</table>
<p class="supporting" style="margin:24px 0;color:#CBD5E1;font-size:14px;line-height:1.65;text-align:left;">${supporting}</p>
...
<!--[if !mso]><!-->
<table class="cta" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;width:410px;max-width:100%;"><tr><td align="center" bgcolor="#2388FF" style="border-radius:12px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 18px rgba(35,136,255,.25);"><a class="ctaLink" href="${secureUrl}" target="_blank" style="display:block;padding:17px 22px;color:#FFFFFF;font-size:18px;font-weight:700;line-height:20px;text-decoration:none;">&#9993;&nbsp;&nbsp; OPEN OFFER LETTER</a></td></tr></table>
<!--<![endif]-->
<table role="presentation" align="center" width="100%" cellpadding="0" cellspacing="0" style="margin:30px 0 0;"><tr><td style="border-top:1px solid #2388FF;line-height:1px;">&nbsp;</td><td width="38" style="color:#10D9F5;font-size:18px;">&#10022;</td><td style="border-top:1px solid #8B2CF5;line-height:1px;">&nbsp;</td></tr></table>
<p class="autoNotice" style="margin:17px 0 0;color:#CBD5E1;font-size:15px;line-height:1.6;">This is an automated email. No reply is required.</p>
<p class="footerText" style="margin:24px 0 4px;color:#CBD5E1;font-size:14px;">MashRoute | Student Application Management Portal</p><p class="footerText" style="margin:0;color:#94A3B8;font-size:14px;">Simplifying Every Step of the Student Journey</p>
</td></tr></table>
