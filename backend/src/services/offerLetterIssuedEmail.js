...
<!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" href="${secureUrl}" style="height:44px;v-text-anchor:middle;width:260px;" arcsize="20%" fillcolor="#2388FF" strokecolor="#2388FF"><w:anchorlock xmlns:w="urn:schemas-microsoft-com:office:word"/><center style="color:#FFFFFF;font-family:Arial,sans-serif;font-size:14px;font-weight:bold;">OPEN OFFER LETTER</center></v:roundrect><![endif]-->
<!--[if !mso]><!-->
<table class="cta" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;width:260px;max-width:78%;"><tr><td align="center" bgcolor="#2388FF" style="border-radius:10px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 18px rgba(35,136,255,.25);"><a class="ctaLink" href="${secureUrl}" target="_blank" style="display:block;padding:13px 16px;color:#FFFFFF;font-size:14px;font-weight:700;line-height:18px;text-decoration:none;white-space:nowrap;">OPEN OFFER LETTER</a></td></tr></table>
<!--<![endif]-->
