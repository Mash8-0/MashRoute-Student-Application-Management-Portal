...
function renderHtml(input) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@supports (-webkit-background-clip:text){.gradientText{background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}.panelTitle{background-image:linear-gradient(90deg,#10D9F5,#8B2CF5);-webkit-background-clip:text;background-clip:text;color:transparent!important}}@media only screen and (max-width:640px){.shell{padding:4px!important}.card{width:100%!important;max-width:100%!important;border-radius:14px!important}.pad{padding-left:14px!important;padding-right:14px!important}.topPad{padding-top:16px!important}.contentPad{padding-bottom:20px!important}.hero{font-size:18px!important;letter-spacing:-.3px!important;line-height:1.18!important}.title{font-size:23px!important;line-height:1.14!important;margin-top:7px!important}.label,.value{display:block!important;width:auto!important;text-align:left!important;padding-left:14px!important;padding-right:14px!important}.label{font-size:11px!important;padding-top:8px!important;padding-bottom:0!important}.value{font-size:13px!important;padding-top:2px!important;padding-bottom:6px!important}.art{width:130px!important;max-width:52%!important}.cta{width:100%!important}.ctaLink{font-size:14px!important;padding:14px 10px!important}.accent{width:40px!important}.salute{margin-bottom:6px!important;font-size:14px!important}.intro{font-size:13px!important;line-height:1.5!important;margin-bottom:16px!important}.supporting{font-size:12px!important;line-height:1.45!important;margin:15px 0!important}.panelHeading{padding:12px 14px 8px!important}.panelTitle{font-size:13px!important}.autoNotice{font-size:12px!important}.footerText{font-size:10px!important;line-height:1.4!important}}</style></head>
...
<!--[if !mso]><!-->
<table class="cta" role="presentation" align="center" cellpadding="0" cellspacing="0" style="margin:0 auto;width:360px;max-width:100%;"><tr><td align="center" bgcolor="#2388FF" style="border-radius:11px;background:#2388FF;background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);box-shadow:0 0 18px rgba(35,136,255,.25);"><a class="ctaLink" href="${secureUrl}" target="_blank" style="display:block;padding:14px 18px;color:#FFFFFF;font-size:16px;font-weight:700;line-height:20px;text-decoration:none;">&#9993;&nbsp;&nbsp; OPEN OFFER LETTER</a></td></tr></table>
<!--<![endif]-->
