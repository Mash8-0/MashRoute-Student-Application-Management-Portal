...
${[['Student Name', `<strong>${escapeHtml(props.studentName)}</strong>`], ['Passport No.', `<strong>${escapeHtml(props.passportNumber)}</strong>`], ['Programme', escapeHtml(props.programmeName)], ['Campus', escapeHtml(props.campusName)]].map(([label, value]) => `<tr><td class="label" width="35%" style="padding:9px 18px;color:#CBD5E1;font-size:13px;text-align:left;vertical-align:top;">${label}</td><td class="value" style="padding:9px 18px;color:#F8FAFC;font-size:14px;text-align:left;vertical-align:top;word-break:break-word;"><span style="color:#CBD5E1;">:&nbsp;&nbsp;</span>${value}</td></tr>`).join('')}
</table>
