...
<table class="details" role="presentation" width="90%" align="center" cellpadding="0" cellspacing="0" style="width:90%;margin:0 auto;background:#08172E;border:1px solid #334561;border-radius:16px;box-shadow:inset 0 0 20px rgba(16,217,245,.03);">
...
${[['Student Name', `<strong>${escapeHtml(props.studentName)}</strong>`], ['Passport No.', `<strong>${escapeHtml(props.passportNumber)}</strong>`], ['Programme', escapeHtml(props.programmeName)], ['Campus', escapeHtml(props.campusName)]].map(([label, value]) => `<tr><td class="label" width="35%" style="padding:5px 18px;color:#CBD5E1;font-size:13px;line-height:1.25;text-align:left;vertical-align:top;">${label}</td><td class="value" style="padding:5px 18px;color:#F8FAFC;font-size:14px;line-height:1.25;text-align:left;vertical-align:top;word-break:break-word;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;font-size:inherit;line-height:1.25;"><tr><td width="16" style="width:16px;color:#CBD5E1;font-size:inherit;line-height:1.25;vertical-align:top;">:</td><td style="color:#F8FAFC;font-size:inherit;line-height:1.25;vertical-align:top;word-break:break-word;">${value}</td></tr></table></td></tr>`).join('')}
</table>
