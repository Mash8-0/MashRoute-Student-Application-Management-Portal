...
function renderHtml(input) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@supports (-webkit-background-clip:text){.gradientText{background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}.panelTitle{background-image:linear-gradient(90deg,#10D9F5,#8B2CF5);-webkit-background-clip:text;background-clip:text;color:transparent!important}}@media only screen and (max-width:640px){.shell{padding:6px!important}.card{width:100%!important;max-width:100%!important;border-radius:16px!important}.pad{padding-left:18px!important;padding-right:18px!important}.hero{font-size:24px!important;letter-spacing:-.2px!important}.title{font-size:29px!important}.label,.value{display:block!important;width:auto!important;text-align:left!important}.value{padding-top:1px!important;padding-bottom:7px!important}.art{width:190px!important}.cta{width:100%!important}.accent{width:58px!important}.salute{font-size:17px!important}.panelTitle{font-size:15px!important}}</style></head>
