...
function renderHtml(input) {
  ...
  return `<!doctype html>
<html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>@supports (-webkit-background-clip:text){.gradientText{background-image:linear-gradient(90deg,#10D9F5 0%,#2388FF 48%,#8B2CF5 100%);-webkit-background-clip:text;background-clip:text;color:transparent!important}.panelTitle{background-image:linear-gradient(90deg,#10D9F5,#8B2CF5);-webkit-background-clip:text;background-clip:text;color:transparent!important}}@media only screen and (max-width:640px){.shell{padding:10px 0!important}.card{width:calc(100% - 20px)!important;max-width:calc(100% - 20px)!important;border-radius:18px!important;box-sizing:border-box!important}.pad{padding-left:20px!important;padding-right:20px!important}.hero{font-size:33px!important;letter-spacing:.5px!important}.title{font-size:36px!important}.label,.value{display:block!important;width:auto!important;text-align:left!important}.value{padding-top:1px!important;padding-bottom:8px!important}.art{width:240px!important}.cta{width:100%!important}.accent{width:72px!important}.salute{margin-bottom:22px!important;font-size:18px!important}}</style></head>
...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;table-layout:fixed;background:#020B1D;"><tr><td class="shell" align="center" style="padding:28px 12px;">
<table class="card" role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;max-width:640px;background:#06132A;border:2px solid #10D9F5;border-radius:28px;overflow:hidden;box-shadow:0 0 34px rgba(35,136,255,.24),0 0 18px rgba(139,44,245,.12);">
<tr><td class="pad" style="padding:36px 46px 12px;text-align:center;"><p class="salute" style="margin:0 0 26px;text-align:left;font-size:20px;line-height:1.55;color:#CBD5E1;">Dear <strong style="color:#F8FAFC;">${salutation}</strong>,</p><img class="art" src="${escapeHtml(props.illustrationUrl)}" width="340" alt="Offer Letter Issued" style="display:block;margin:0 auto;width:340px;max-width:100%;height:auto;border:0;filter:drop-shadow(0 0 12px rgba(35,136,255,.32));"></td></tr>
<tr><td class="pad" style="padding:8px 46px 38px;text-align:center;">
<h1 class="hero" style="margin:0;color:#F8FAFC;font-size:46px;line-height:1.12;letter-spacing:1.5px;text-transform:uppercase;">CONGRATULATIONS!</h1>
<h2 class="title" style="margin:14px 0 15px;color:#10D9F5;font-size:50px;line-height:1.1;"><span class="gradientText" style="color:#10D9F5;">Offer Letter Issued</span></h2>
...
<p style="margin:0 0 27px;text-align:left;color:#F8FAFC;font-size:17px;line-height:1.65;">We are pleased to inform you that the Offer Letter has been issued as per the details below:</p>
...
<p style="margin:24px 0;color:#CBD5E1;font-size:14px;line-height:1.65;text-align:left;">${supporting}</p>
...
<p style="margin:17px 0 0;color:#CBD5E1;font-size:15px;line-height:1.6;">This is an automated email. No reply is required.</p>
<p style="margin:24px 0 4px;color:#CBD5E1;font-size:14px;">MashRoute | Student Application Management Portal</p><p style="margin:0;color:#94A3B8;font-size:14px;">Simplifying Every Step of the Student Journey</p>
</td></tr></table>
