...
<tr><td class="pad" style="padding:36px 46px 12px;text-align:center;"><p class="salute" style="margin:0 0 26px;text-align:left;font-size:15px;line-height:1.6;color:#CBD5E1;">Dear <strong style="color:#F8FAFC;">${salutation}</strong>,</p><img class="art" src="${escapeHtml(props.illustrationUrl)}" width="360" alt="Offer Letter Issued" style="display:block;margin:0 auto;width:360px;max-width:100%;height:auto;border:0;filter:drop-shadow(0 0 12px rgba(35,136,255,.32));"></td></tr>
