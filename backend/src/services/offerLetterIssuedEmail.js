...
${[['Student Name', `<strong>${escapeHtml(props.studentName)}</strong>`], ['Passport No.', `<strong>${escapeHtml(props.passportNumber)}</strong>`], ['Programme', escapeHtml(props.programmeName)], ['Campus', escapeHtml(props.campusName)]].map(([label, value]) => `<tr><td class="label" width="35%" style="padding:9px 18px;color:#CBD5E1;font-size:13px;text-align:left;vertical-align:top;">${label}</td><td class="value" style="padding:9px 18px;color:#F8FAFC;font-size:14px;text-align:left;vertical-align:top;word-break:break-word;"><table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="width:100%;"><tr><td width="16" style="width:16px;color:#CBD5E1;vertical-align:top;">:</td><td style="color:#F8FAFC;vertical-align:top;word-break:break-word;">${value}</td></tr></table></td></tr>`).join('')}
</table>
